...
export function PaymentModal({ open, onOpenChange, onSuccess }: PaymentModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white">
        {wechatPayData ? (
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-white dark:bg-slate-600 border-slate-200 dark:border-slate-500 text-slate-900 dark:text-white"
                    />
                  </div>
              ...
              <div className="space-y-2">
                ...
                <div className="border-t border-slate-200 dark:border-slate-600 pt-2 mt-2">
                  <div className="flex justify-between font-semibold">
                    <span>Total:</span>
                    <span className="text-blue-600 dark:text-blue-400">${selectedPlanData?.price} {selectedPlanData?.currency}</span>
                  </div>
                </div>
              </div>
            </div>
